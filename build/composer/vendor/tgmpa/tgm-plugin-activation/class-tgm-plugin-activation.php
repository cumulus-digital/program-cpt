...
*/
if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGM_Plugin_Activation')) {
    /**
            ...
            if (!empty($message) || $total_required_action_count > 0) {
                ...
                if (!\current_user_can('activate_plugins') && !\current_user_can('install_plugins') && !\current_user_can('update_plugins')) {
                    ...
                    foreach ($message as $type => $plugin_group) {
                        ...
                        $linked_plugins = \array_map(array('CUMULUS\Wordpress\ProgramCPT\TGMPA_Utils', 'wrap_in_em'), $linked_plugins);
...
if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGMPA_List_Table')) {
    /**
        ...
        public function process_bulk_actions()
        {
            ...
            if ('tgmpa-bulk-activate' === $this->current_action()) {
                ...
                if (\is_wp_error($activate)) {
                    ...
                    $plugin_names = \array_map(array('CUMULUS\Wordpress\ProgramCPT\TGMPA_Utils', 'wrap_in_strong'), $plugin_names);
...
if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGM_Bulk_Installer')) {
    /**
...
if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGM_Bulk_Installer_Skin')) {
    /**
...
if (!\function_exists('CUMULUS\\Wordpress\\ProgramCPT\\tgmpa_load_bulk_installer')) {
    ...
    function tgmpa_load_bulk_installer()
    {
        ...
        if (isset($_GET['page']) && $tgmpa_instance->menu === $_GET['page']) {
            ...
            if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGMPA_Bulk_Installer')) {
                /**
            ...
            if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGMPA_Bulk_Installer_Skin')) {
                /**
...
if (!\class_exists('CUMULUS\\Wordpress\\ProgramCPT\\TGMPA_Utils')) {
    /**
